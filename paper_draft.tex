...
bias is only \SI{1.80}{\micro\meter}; the safe limit is
$\SI{1669}{\micro\meter}$, 5.6$\times$ above the realistic value
(Section~\ref{sec:whiteness}).
