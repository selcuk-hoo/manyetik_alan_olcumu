...
indirgenebilmektedir. Bu bölümdeki tüm simülasyonlar üniform
$G=\SI{0.2}{\tesla\per\meter}$ FODO kafesinde (48 kuadrupol,
$Q_y\approx2{,}68$), kapalı-yörünge fırlatma koşulunda (CO=True) ve
$T=\SI{0.5}{\milli\second}$ spin takibiyle yapılmıştır.
