...
edilebildiğinde tepki matrisinin rank'ı ve koşullanması ciddi biçimde bozulur.
...
Sahte EDM oranı ile hizalama hatası hızı arasındaki bağıntı doğrusal ve zamandan
bağımsızdır:
\begin{equation}
  \frac{dS_y}{dt} = \mathcal{F}\!\left[\{\Delta y_j\}\right],
\end{equation}
burada $\mathcal{F}$ tepki matrisinden ve halka optiklerinden türetilen
bir fonksiyoneldır. Önemli olan, bu fonksiyonelin $k=2$
Fourier harmonik bileşenine ($N=24$ FODO hücreli bir halkada)
bağımlılığının diğer tüm bileşenlerden bir mertebe fazla olmasıdır.
...
boyunca sabit fakat bilinmez) ve $\boldsymbol{\eta}\sim\SI{1}{\micro\meter}$
...
olarak uyduran standart bir algoritmadır~\cite{todo-loco}. Güçlü yönü
...
Dikkatli veri analiziyle tüm kuadrupoller eş zamanlı modüle edilerek
yöntem uygulanabilir kılınabilir; ancak aşağıda açıklanan temel kısıtlama
her iki yaklaşım için de geçerlidir.
...
Eşleşmiş-filtre SNR'si $\sigma_b=\SI{100}{\micro\meter}$ için:
\begin{equation}
...
\subsection{Algoritmanın çalışma prensibi}
...
\begin{tabular}{lccc}
\toprule
Kaynak & Seviye & $k=1$ ($\mu\pm\sigma$) & $k=2$ ($\mu\pm\sigma$) \\
\midrule
BPM gürültüsü  & $5\,\mu$m   & $-0{,}93\pm0{,}38$ & $-0{,}74\pm0{,}32$ \\
BPM ofseti     & $50\,\mu$m  & $-0{,}80\pm3{,}98$ & $-0{,}13\pm2{,}51$ \\
Kuadrupol rulosu & $1\,\mathrm{mrad}$ & $-0{,}89\pm0{,}62$ & $-0{,}62\pm1{,}92$ \\
Gradyan hatası & $0{,}5\%$   & $-0{,}90\pm1{,}45$ & $-0{,}84\pm3{,}94$ \\
\midrule
Kombinat       & tümü        & $-0{,}83\pm4{,}38$ & $-0{,}12\pm5{,}37$ \\
\bottomrule
\end{tabular}
\begin{tabular}{lc}
\toprule
Kaynak & $k=3$ ($\mu\pm\sigma$) \\
\midrule
BPM gürültüsü  & $-0{,}92\pm0{,}49$ \\
BPM ofseti     & $-0{,}66\pm4{,}69$ \\
Kuadrupol rulosu & $-0{,}95\pm0{,}72$ \\
Gradyan hatası & $-1{,}15\pm1{,}71$ \\
\midrule
Kombinat       & $-0{,}69\pm5{,}21$ \\
\bottomrule
\end{tabular}
...
\begin{itemize}
  \item \textbf{Gerçek kafes parametreleriyle doğrulama.}
    Bu çalışmada idealize edilmiş $N_\mathrm{FODO}=24$ halkası kullanılmıştır.
    Brookhaven ya da Jülich pEDM tasarımı gibi gerçek bir kafes ile aynı
    analizin tekrarlanması iddianın gücünü artıracaktır.
  ...
  \item \textbf{Gradyan kalibrasyonu.}
    Monte Carlo analizinde $\sigma_G=0{,}5\%$ baskın belirsizlik kaynağıdır.
    $\sigma_G\lesssim0{,}2\%$'ye indirilmesi kombinat belirsizliği $\sim2\%$'ye
    çekecektir.
...
\bibitem{todo-loco} \todo{LOCO referansı}
