...
baskındır: 0.3~$\mu$m kalan üstüne $\psi=0.1$~mrad bütçeyi değiştirmez,
$\psi=1$~mrad $\sim$3$\times$ aşar (Tablo~\ref{tab:syst}). \emph{Dürüst sınır:}
dx,dy AC-BBA tilt'i ölçmez $\to$ tilt mekanik ($\lesssim$0.1--0.3~mrad, modern
survey ulaşır) veya skew-BBA ile ayrı kontrol edilmelidir. CW/CCW+quad-flip bunu
...
Quad tilt (roll) & $\psi\lesssim0.1$--$0.3$~mrad \\
