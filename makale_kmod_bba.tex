...
kurtarmaz: idealize latiste CCW$\equiv$CW+flip (dejenerasyon, oran 1.00; flip
bağımsız knob değil) ve ters-çevirme geometrik fazı yalnız $\sim$3.4$\times$
(ensemble) bastırır, NULL'lamaz.
