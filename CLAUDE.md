...
- Sürüm etiketleri: `v1.1 … v4.2` (en güncel: v4.2 — literatür kıyası + stratejik
  karar). **Bu ortamda tag push'u 403 ile engellenir**; tag'ler yerel makineden
  oluşturulup itilir. Branch (main) push'u sorunsuz çalışır.
