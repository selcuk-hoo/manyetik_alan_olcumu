...
| **Off-momentum spin-sensing (magic-olmayan p + E-rescale): telafi ÇALIŞIR (tek quad ofseti magic f'i 182→0 @+22μm null'lar, rank duvarı yok) AMA off-momentum proxy YANILTIR — geometrik faz σ² AMPLİFİYE olur (∝1/ν_s, kullanıcı sezgisi doğru) fakat 1.-mertebe ISA-eğimi σ¹ aynı ν_s'te ~3600× büyük gömüyor. Tüm ayırma kapalı: δ(kesişim δ~3e-7), faz(desene bağlı 91°), 4-fold(σ¹ sönmez, oran 1.000), RMS(kesişim 62mm). Magic ν_s=0 = 1.-mertebeyi nötrleyen TEK nokta** | `akilli_duzeltme.md §6.16` |
