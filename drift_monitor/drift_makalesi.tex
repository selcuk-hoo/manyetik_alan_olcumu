...
bastırılır. Bu, kapalı yörüngenin esasen bir \textbf{rezonant alçak-geçiren
...
\paragraph{Yavaş mutlak katman (saatlik--günlük).} LOCO + BBA + survey ile
mutlak hizalama $\Delta q_0$, BPM ofseti $\mathbf{b}_0$ ve örgü modeli
...
\item \textbf{BPM ofset uzun-vadeli kararlılığı.} Drift modunun temel
  varsayımı $\mathbf{b}(t)\approx\mathbf{b}_0$ olduğundan, donanımın
  saatler--günler ölçeğinde ofset stabilitesi deneysel olarak karakterize
  edilmelidir.
\end{itemize}
...
\bibitem{omarov2022}
Z.~Omarov, H.~Davoudiasl, \emph{et al.} (Y.~K.~Semertzidis dahil),
...
(2022).
\bibitem{pedm2011}
pEDM Collaboration, ``Storage Ring Proton Electric Dipole Moment Experiment
Proposal,'' BNL (2011).
\bibitem{lee}
