...
\paragraph{İzleyici doğrulaması.} Yukarıdaki tarama $\beta$-beating'i analitik
olarak ($\beta,\phi$ doğrudan bozularak) modelliyordu. Bunu $\beta$-beating'in
gerçek kaynağıyla --- kuadrupol fraksiyonel gradyan hatalarıyla --- tam parçacık
izleyicisinde tekrarladık: bozulmuş $R_\text{true}$ izleyiciden kuruldu, monitör
nominal $R_\text{nom}^{-1}$ ile çalıştı. Gradyan hatası RMS'i $0,\,2\%,\,5\%$
için drift takip hatası $6.17,\,6.17,\,6.25\,\mu$m ($\kappa$: $228\to239\to233$).
Gerçek gradyan-hatası kaynaklı $\beta$-beating analitik taramadan bile daha
sağlam çıktı; Test 8 tam parçacık dinamiğiyle doğrulandı.
(\texttt{drift\_betabeat\_sim.py})
