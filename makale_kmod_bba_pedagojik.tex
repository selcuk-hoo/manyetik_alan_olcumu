...
görünmez. O hâlde tilt ya mekanik olarak $\lesssim 0.1$~mrad'a hizalanmalı (tipik
survey'den biraz sıkı ama olağan), ya da \emph{skew}-bileşeni modüle eden bir
``skew-BBA'' uzantısıyla ölçülmelidir. Bu, $\beta$-beating'den ayrı, açıkça
belirtilen bir bütçe kalemidir.}
